...
- **Roll Number / Batch:** B.Tech CSE, 2nd Year, Semester 3 (UPES, Dehradun)
...
5. Added a mobile navigation toggle and responsive CSS grid breakpoints so the layout adapts from desktop down to phone width.
...
- **GitHub repo:** `https://github.com/<your-username>/<your-repo>`  ← replace with your actual repo URL

> Remember to update the two links above, and the placeholder GitHub/LinkedIn links inside `index.html`, with your real URLs before submitting.
